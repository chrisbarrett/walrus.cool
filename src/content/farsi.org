...
** Verb endings
- Verbs in Farsi are learned by memorising the /present/ and /past/ stems
- Verbs in most tenses are conjugated by adding suffixes
...
- The past tense endings are identical, except there is no /3 s/ ending (the stem
  is left bare)
- The present tense is formed by taking the present stem and adding the
  appropriate ending.
- Infinitives are built from the past steam and end in either /تن/ or /دن/
** To Be: بودن
...
- کجاست…؟ :: where is…?
** Where You're From
- اهل [کجایین/کجایید]؟ اهل کجا هستـ[ید/ین]؟ :: where are you from? (formal)
- از کدوم کشور[ـید/ـین]؟ از کدوم هستـ[ـید/ـین]؟ :: which country are you from? (formal)
  - کشور :: country
  - کدوم :: which (written)
  - کدام :: which (spoken)
